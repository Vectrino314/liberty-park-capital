...
// Changes the gradient for every box element where every category sits
...
// grid-template-columns: minmax(changes width of component, )
...
// This is the template in which the items populate, changing anything here
