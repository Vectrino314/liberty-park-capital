  ...
  <Base {...props}>
    <Green>
      ...
      <Lead maxWidth={36} mx="auto" color="white" fontSize={[3, 4]} my={2}>
        Going and creating a website can be tedious and going through a
        third-party to make you one can be a hassle. At Ardorem, we streamline
        our process to make sure you're our top priority. With readily
        accessible documents and design selection as easy as multiple choice,
