...
const Event = ({
  ...
  <Details key={organizer}>
    <DetailStats>
      <DetailStats.Item value={attendees} label="leads" />
  ...
  <Base>
    <Container align="center" maxWidth={36} mb={[4, 5]} px={3}>
      <Subhline color="white">
        Successful business have a face that tells their story.
      </Subhline>
      <Lead color="muted">
        Hear from our clients what it means to run a business and look good doin
        it.
      </Lead>
    </Container>
    <Main maxWidth={60}>
